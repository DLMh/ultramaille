...
<head>
    ...
    <link rel="stylesheet" href="../../front/general/assets/fonts/font-awesome.min.css">
    <link rel="stylesheet" href="../../front/general/assets/fonts/material-icons.min.css">
    <link rel="stylesheet" href="../../front/general/assets/css/aos.min.css">
    <link rel="stylesheet" href="../../front/general/assets/css/Dark-Mode-Switch.css">
...
<body style="font-size: 13px;">
   ...
   <div class="container mt-5">
        <a href="../../front/general/menu-administration-v2.php">
    ...
    <div class="container mt-5">
        <h3 class="text-center">Listes des utilisateurs</h3>
        <!-- Table HTML -->
            ...
            <tbody>
                ...
                <tr  style="cursor:pointer;">
                    ...
                    <td class="text-center">
                        <a  href="assignation_module_form.php?id=<?php  echo $row['id_user']?>" class="text-primary" title="Assigner">
    ...
    <script src="../../front/general/assets/bootstrap/js/bootstrap.min.js"></script>
    <script src="../../front/general/assets/js/aos.min.js"></script>
    <script src="../../front/general/assets/js/bs-init.js"></script>
    <script src="../../front/general/assets/js/bold-and-bright.js"></script>
    <script src="../../front/general/assets/js/Dark-Mode-Switch-darkmode.js"></script>
